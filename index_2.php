...
<head>
    ...
    <style>
        ...
        /* Synthwave Parking Button Styles - FIXED CAR */
        ...
        @keyframes movingCarMini {
            0% { bottom: 15px; scale: 1; }
            19% { bottom: 25px; scale: 0; }
            20% { bottom: -300px; scale: 1.5; }
            30% { bottom: 15px; scale: 1; }
        }
        ...
        .tailLight-mini {
            width: 15px;
            background: linear-gradient(90deg, rgba(255, 255, 0, 0.8), rgba(255, 0, 0, 0.6));
            animation: blinkingLightsMini infinite 2s;
        }

        .tailLight-mini:first-child {
            clip-path: polygon(0% 100%, 100% 100%, 100% 0%, 20% 0%);
        }

        .tailLight-mini:last-child {
            clip-path: polygon(0% 100%, 100% 100%, 80% 0%, 0% 0%);
        }

        @keyframes blinkingLightsMini {
            0%, 49% { opacity: 1; }
            50%, 100% { opacity: 0.3; }
        }
        ...
        <div class="darkveil-content">
            <div class="container-fluid mt-4">
                ...
                <div class="row mb-4">
                    ...
                    <!-- ANIMATED FIND PARKING BUTTON (WITH FIXED CAR) -->
                    <div class="col-lg-3 col-md-6 mb-4">
                            ...
                            <div class="card synthwave-parking-card">
                                <div class="card-body p-0">
                                    <div id="synthwave-mini">
                                        ...
                                        <!-- FIXED CAR WITH PROPER HTML STRUCTURE -->
                                        <div id="car-mini">
                                            <div id="lightsSection-mini">
                                                <div id="lights0-mini"></div>
                                                <div id="lights1-mini"></div>
                                                <div id="lights2-mini">
                                                    <div class="tailLight-mini"></div>
                                                    <div class="tailLight-mini"></div>
                                                </div>
                                            </div>
                                            <div id="bumper-mini"></div>
                                        </div>
